...
public record RegisterRequest(
        ...
        /**
         * BCP-47-ish code (e.g. "hi", "ta", "te", "mr", "pa", "gu",
         * "kn", "bn", "ml", "or"). Optional — AuthServiceImpl falls
         * back to "en" when omitted or blank. See
         * ai/util/LanguageInstructions for the supported set.
         */
