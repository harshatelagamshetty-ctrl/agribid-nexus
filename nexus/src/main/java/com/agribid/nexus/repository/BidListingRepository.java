...
public interface BidListingRepository extends
    ...
    // used by FpoPoolingService.getPayoutBreakdown to trace a pool's
    // resulting aggregate CropLot forward to the listing it was
    // eventually published as
    java.util.Optional<BidListing> findByCropLotId(Long cropLotId);
}